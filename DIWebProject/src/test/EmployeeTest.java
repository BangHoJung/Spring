...
//		System.out.println(file.exists());
		...
		//DB 연결
		conn = AppContext.getContext().getBean(DBManager.class).getConnection();
...
//		}
	...
	@Test
	void test() {
		ArrayList<EmployeeDTO> list = AppContext.getContext().getBean(EmployeeDAO.class).searchEmployeeAll();
		if(list.size() == 0) 
		{
